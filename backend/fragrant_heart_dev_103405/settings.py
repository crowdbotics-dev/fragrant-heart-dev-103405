"""
Django settings for fragrant_heart_dev_103405 project.
...
ROOT_URLCONF = 'fragrant_heart_dev_103405.urls'
...
WSGI_APPLICATION = 'fragrant_heart_dev_103405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_heart_dev_103405 API",
    "DESCRIPTION": "API documentation for fragrant_heart_dev_103405 App",
    "VERSION": "v1",
}
